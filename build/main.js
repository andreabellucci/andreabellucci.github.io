...
var RootModalPage = (function () {
    function RootModalPage(navCtrl, viewCtrl, navParams, http) {
        ...
        this.gettyCredentials = {
            apiKey: "9vqy2ufs5vr5jfurr9rhhg8e",
            apiSecret: "hypSRgF5Y9YpTRF8mTJs8xHeQh5dukNntChp2ay6YedEg",
    ...
    RootModalPage.prototype.searchImages = function () {
        ...
        this.http.get('https://api.gettyimages.com/v3/search/images?phrase=' + this.label, { headers: headers })
...
RootModalPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-root-modal',template:/*ion-inline-start:"/Users/abellucc/Documents/Workspace/ionic-webby/src/pages/root-modal/root-modal.html"*/'<!--\n  Generated template for the ConceptModalPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>{{concept}}</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n	 	<!--<button ion-button outline> Add image <ion-icon name="add" (click)=\'searchImage( )\'></ion-icon></button>-->\n		<ion-label stacked>Select an image</ion-label>\n		<ion-searchbar\n  		[(ngModel)]="label"\n  		[showCancelButton]="shouldShowCancel"\n  		(ionInput)="onInput($event)"\n  		(ionCancel)="onCancel($event)">\n		</ion-searchbar>\n\n		<ion-scroll scrollY="true">\n\n	 <ion-grid>\n		<ion-row>\n			 <ion-spinner text-center name="bubbles" *ngIf=showSpinner></ion-spinner>\n		</ion-row>\n\n	 <ion-row wrap *ngFor="let row of grid">\n		 <ion-col width-33 *ngFor="let img of row" >\n			 <img src="{{img.display_sizes[0].uri}}" (click)="selectImage($event)" >\n		 </ion-col>\n	  </ion-row>\n	 </ion-grid>\n</ion-scroll>\n\n\n	<ion-label stacked>Select a color</ion-label>\n\n\n	<button ion-button block outline (click)=\'dismiss( )\'>Add</button>\n</ion-content>\n'/*ion-inline-end:"/Users/abellucc/Documents/Workspace/ionic-webby/src/pages/root-modal/root-modal.html"*/,
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ViewController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* ViewController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavParams */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_http__["b" /* Http */]) === "function" && _d || Object])
], RootModalPage);
